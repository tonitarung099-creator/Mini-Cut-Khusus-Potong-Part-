...
- **SRT wajib untuk AI dan ekspor** — AI Film Cut memakai SRT sinkron untuk memahami dialog, dan setiap ekspor wajib menghasilkan pasangan video + SRT. MiniCut memakai SRT yang sudah dipilih, referensi SRT proyek, atau `NamaVideo.srt` yang terdeteksi otomatis; jika belum ada SRT valid, aplikasi wajib meminta pengguna memilih SRT sebelum ekspor dapat dimulai. SRT dipotong menjadi `NamaVideo_Part-01.srt`, `Part-02.srt`, dst.; timestamp tiap part di-reset mulai `00:00:00,000`, dan cue yang melewati boundary diklip ke kedua part tanpa mengubah teks.
